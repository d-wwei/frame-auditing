...
If First Principles or Tacit Knowledge is already in your `AGENTS.md`, place Frame Auditing BEFORE them. Order:
1. Frame Auditing (problem perception layer)
2. First Principles (reasoning input layer)
3. Tacit Knowledge (output quality layer)
